...
/*
    ...
    m_HeaderBackground = m_app.LoadTexture("data/BlueprintBackground.png");
    m_SaveIcon         = m_app.LoadTexture("data/ic_save_white_24dp.png");
    m_RestoreIcon      = m_app.LoadTexture("data/ic_restore_white_24dp.png");
...
{
    auto releaseTexture = [this](SDL_Texture *id)
    {
        if (id)
        {
            m_app.DestroyTexture(id);
            id = nullptr;
        }
    };
...
void Blueprint::ShowLeftPane(float paneWidth)
{
    ...
    int saveIconWidth     = m_app.GetTextureWidth(m_SaveIcon);
    int saveIconHeight    = m_app.GetTextureWidth(m_SaveIcon);
    int restoreIconWidth  = m_app.GetTextureWidth(m_RestoreIcon);
    int restoreIconHeight = m_app.GetTextureWidth(m_RestoreIcon);
...
# endif
    ...
    ed::Begin("Node editor");
    {
        ...
        util::BlueprintNodeBuilder builder(m_HeaderBackground, m_app.GetTextureWidth(m_HeaderBackground), m_app.GetTextureHeight(m_HeaderBackground));
...
ImGuiWindowFlags Blueprint::GetWindowFlags()
{
    return
