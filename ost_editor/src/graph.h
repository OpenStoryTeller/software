...
public:
    ...
    Type&        node(int node_id);
    const Type&  node(int node_id) const;
    ...
    int  insert_node(const Type& node);
...
template<typename Type>
Type& Graph<Type>::node(const int id)
{
    return const_cast<Type&>(static_cast<const Graph*>(this)->node(id));
}

template<typename Type>
const Type& Graph<Type>::node(const int id) const
{
...
template<typename Type>
Span<const int> Graph<Type>::neighbors(int node_id) const
{
...
template<typename Type>
Span<const typename Graph<Type>::Edge> Graph<Type>::edges() const
{
    return edges_.elements();
}

template<typename Type>
size_t Graph<Type>::num_edges_from_node(const int id) const
{
...
template<typename Type>
int Graph<Type>::insert_node(const Type& node)
{
...
template<typename Type>
void Graph<Type>::erase_node(const int id)
{
...
template<typename Type>
int Graph<Type>::insert_edge(const int from, const int to)
{
    const int id = current_id_++;
...
template<typename Type>
void Graph<Type>::erase_edge(const int edge_id)
{
...
void dfs_traverse(const Graph<Type>& graph, const int start_node, Visitor visitor)
{
    std::stack<int> stack;
